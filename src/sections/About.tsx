  ...
  return (
    <SectionFrame label="02 / About">
      <div className="max-w-4xl">
        ...
        <p className="mt-2 text-sm text-slate-600">You can call me {profile.displayName}.</p>
        <h1 id="about-title" className="mt-12 max-w-3xl text-4xl font-medium leading-[1.02] tracking-[-0.05em] sm:text-6xl">
