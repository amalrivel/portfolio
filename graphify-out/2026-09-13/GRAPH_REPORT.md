...
- 141 files · ~226,113 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 2437 nodes · 3029 edges · 172 communities (132 shown, 40 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 33 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `09bdf372`
...
- tsconfig.json
- App.tsx
- Application HTML Entrypoint
- Layered Rounded Platform Hero Graphic
- React
- Vite
- Purple Gradient Lightning Bolt Favicon
- Icon Sprite Sheet
- Bluesky Icon
- Discord Icon
- Documentation Icon
...
- `React TypeScript Vite Template` --conceptually_related_to--> `Application HTML Entrypoint` [INFERRED]
  README.md → index.html
- `Project Graphify Instructions` --references--> `Incremental Update` [EXTRACTED]
...
- **Graphify Extraction Pipeline** — _codex_skills_graphify_skill_ast_extraction, _codex_skills_graphify_skill_semantic_extraction, _codex_skills_graphify_skill_incremental_update [EXTRACTED 1.00]
- **SVG Icon Symbols** — public_icons, public_icons_bluesky_icon, public_icons_discord_icon, public_icons_documentation_icon, public_icons_github_icon, public_icons_social_icon, public_icons_x_icon [EXTRACTED 1.00]

## Communities (172 total, 40 thin omitted)

### Community 0 - "package.json"

Cohesion: 0.09
Nodes (25): name, private, type, version, @babel/core, babel-plugin-react-compiler, @base-ui/react, eslint (+17 more)
...
Cohesion: 0.15
Nodes (15): Add URL and Watch Reference, Exports Reference, Extraction Specification, GitHub and Merge Reference, Hooks Reference, Query Path Explain Reference, Transcription Reference, Update Reference (+7 more)

### Community 6 - "dependencies"

Cohesion: 0.15
Nodes (13): dependencies, @base-ui/react, class-variance-authority, cn, @fontsource-variable/inter, lucide-react, motion, react (+5 more)

### Community 7 - "tooltip.tsx"

Cohesion: 0.20
Nodes (4): class-variance-authority, cn, Button(), buttonVariants
...
Cohesion: 0.15
Nodes (6): react, App(), sections, skillGroups, Project, projects

### Community 11 - "Application HTML Entrypoint"

Cohesion: 0.67
Nodes (3): Application HTML Entrypoint, React Root Mount, React TypeScript Vite Template

### Community 12 - "Layered Rounded Platform Hero Graphic"

Cohesion: 0.67
Nodes (3): Layered Rounded Platform Hero Graphic, Layered Rounded Platform, Purple Neon Accent

### Community 23 - "validate_data.py"
...
### Community 26 - "slide_search_core.py"
...
### Community 27 - "Tailwind CSS Utility Reference"

Cohesion: 0.05
Nodes (43): Arbitrary Values, Aspect Ratio, Background Colors, Border Color, Border Radius, Border Style, Border Width, Borders (+35 more)

### Community 28 - "Brand Guidelines v1.0"
...
### Community 30 - "Canvas Design System"
...
### Community 44 - "Asset Approval Checklist"
...
### Community 45 - "Logo AI Prompt Engineering"
...
### Community 47 - "Color Palette Management"
...
### Community 58 - "test_design_system_mode.py"
...
### Community 61 - "DesignSystemGenerator"
...
### Community 70 - "TestThresholdGate"
...
### Community 75 - "fontSize"

Cohesion: 0.12
Nodes (16): $type, $value, $type, $value, $type, $value, $type, $value (+8 more)

### Community 76 - "TestShadcnInstaller"
...
### Community 81 - "detect_domain"

Cohesion: 0.23
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 82 - "parse_decision_rules"
...
### Community 94 - "Logo Design Reference"
...
### Community 95 - "Token Architecture"
...
### Community 97 - "_select_palette_for_mode"
...
### Community 99 - "validate-tokens.cjs"
...
### Community 108 - "embed-tokens.cjs"
...
### Community 117 - "Component Tokens"
...
### Community 118 - "generate-tokens.cjs"
...
### Community 132 - "shadow"

Cohesion: 0.47
Nodes (6): sm, shadow, sm, sm, $type, $value

### Community 133 - "Slides"

Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 134 - "Pre-Delivery Checklist"
...
### Community 148 - "Tips for Better Results"
...
- **Why does `search()` connect `search` to `.generate`, `scripts/core.py`, `_normalize`, `BM25`, `detect_domain`, `test_text_layout_resilience.py`, `design_system.py`, `validate_data.py`, `_row_identities`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `.generate`, `_select_palette_for_mode`, `BM25`, `design_system.py`, `_palette_is_dark`, `test_data_contracts.py`, `test_design_system_mode.py`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `primitive` connect `primitive` to `spacing`, `color`, `shadow`, `fontSize`, `gray`, `radius`?**
